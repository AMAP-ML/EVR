...
def _get_config(base_model="qwen_image_edit", n_gpus=1, gradient_step_per_epoch=1, reward_fn={}, name=""):
    ...
    config.pretrained.model ="./ckpt/Qwen-Image-Edit"
    ...
    while True:
        ...
        # print(num_groups * config.sample.num_image_per_prompt % (n_gpus * bsz))
        # print(bsz * n_gpus % config.sample.num_image_per_prompt )
        if (
