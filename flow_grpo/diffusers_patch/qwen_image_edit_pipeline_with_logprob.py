...
def encode_prompt(
    ...
    if prompt_embeds is None:
        prompt_embeds, prompt_embeds_mask = _get_qwen_prompt_embeds(self, prompt, image, device, max_seq_len=512)
...
def pipeline_with_logprob(
    ...
    txt_seq_lens = [512] * prompt_embeds.shape[0]
    negative_txt_seq_lens = [512] * prompt_embeds.shape[0]
    img_shapes = img_shapes*prompt_embeds.shape[0]
    ...
    # print(f'latents_shape{latents.shape}')
    # print(f'image_latents.shapoe{image_latents.shape}')
    # print(f'prompt_embed.shape{prompt_embeds.shape}')
    # print(f"image_shapes{img_shapes}")
    return (
        image,
        all_latents,
        image_latents,
